...
public class LoginScreen extends Activity {
	...
	protected int dologin() {
        ...
        String base64password =Base64.encodeToString(password_text.getBytes(),40);
...
//------------- send device id
		...
		try {
			...
			final String serverip = getResources().getString(R.string.bankServerIP);
			final String serverport = getResources().getString(R.string.bankServerPort);
